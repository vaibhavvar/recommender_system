...
$f=mysql_fetch_array(mysql_query("select * from output where user='$user'"));
	   ...
	   <div class="container">
			...
			<table class="timetable">
							    <thead>
									<tr>
										<th>Maths</th> 
										<th>Biology</th>  <th>Commerce</th>
										<th>Humanities</th>
								    </tr>
								</thead>
								<tbody>
							    <tr>
									<td><input name="school" type="text" value="<?php echo $f['pcm'] ?>" class="no-box"  ></td>
                                    <td><input name="board" type="text" value="<?php echo $f['pcb'] ?>" class="no-box"  ></td>
									<td><input name="year" type="text" value="<?php echo $f['co'] ?>" class="no-box"  ></td>
									<td><input name="percent" type="text" value="<?php echo $f['hu'] ?>" class="no-box"  ></td>
								</tr>
						   </tbody>
			</table>
