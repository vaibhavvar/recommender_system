...
<html>
<head>
<title>Student Recommender System | Register </title>
...
<!-- banner -->
  <div class="courses_banner">
	...
	<div class="courses_box1">
	   <div class="container">
	   	  <form class="login" name="form" method="post" enctype="multipart/form-data" onSubmit="return(validate());">
                ...
                <div class="form-group">
                    <input type="text" autocomplete="off" class="required form-control" placeholder="Username *" name="user" value="">
                </div>
                <div class="form-group">
                    <input type="password" class="required form-control" id="pass" placeholder="Password *" name="pass" value="">
                </div>
                <div class="form-group">
                    <input type="password" class="required form-control" id="pass1" placeholder="Conform Password *" name="pass1" value="" onKeyUp="checkPass(); return false;">
                </div>
                 <script>
 function validate()
 {
	 ...
	 if(!ppass.test(b))
	 {
		 alert("Invlaid Credentials: Please enter the correct.");
	 ...
	 return true;
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-primary btn-lg1 btn-block" name="go" value="Register">
                </div>
...
<?php
 ...
 if(isset($_POST['go']))
 {
	 	$qry=mysql_query("select user from students where '$user'=user");
 		$num=mysql_num_rows($qry);

	    if($pass==$pass1 && $num==0 ){
		extract($_POST); 
	 	 
	$q=mysql_query("insert into students (name,user,password) values ('$name','$user','$z')");
	 if($q)
	 {		 
